...
const ImageCardII: React.FC<ImageCardProps> = ({ imgSrc, title, description,  more, flag, url  }) => {
  return (
    <a href={url} className="relative w-full md:w-[49%] flex flex-col md:h-[280px] h-[160px] rounded-2xl justify-between p-4 cursor-pointer text-[0px]">
      ...
      <div className="flex flex-row items-center content-center text-white z-10 gap-2 h-6">
        ...
        <span className={`flex items-end h-full p-1 ${flag == 0 ? 'rotate-0' : 'rotate-180'}`}>
