...
interface SubMenuProps {
    ...
    isOpen: boolean; // Prop to control the open state from the parent
    onToggle: () => void; // Prop to handle toggle action from the parent
}

export default function SidebarSubMenu({ title, items, isOpen, onToggle }: SubMenuProps) {
    return (
        <div className="w-full">
            ...
            >
                <div className="relative h-full w-full flex justify-between items-center">
                    <p className="text-sm font-medium text-primText">{title}</p>
                    <p>
                        <svg
