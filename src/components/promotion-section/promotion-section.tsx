    ...
    return(
        <div className="flex flex-row w-full justify-center content-center h-[360px] relative" aria-labelledby="Amrk-Demo-Promotion-Section">
            ...
            <div className="flex flex-col md:flex-row w-[88%] xl:max-w-[1200px] justify-around md:justify-between items-start md:items-center z-10">
                ...
                <a href="/demo-schedule" className="hover:before:bg-PrimBtn relative flex items-center justify-center w-full md:w-[243px] h-[72px] rounded-2xl text-PrimBtn overflow-hidden border-2 border-PrimBtn bg-transparent px-3 transition-all before:absolute before:bottom-0 before:right-0 before:top-0 before:z-0 before:h-full before:w-0 before:bg-PrimBtn before:transition-all before:duration-500 hover:text-white hover:before:right-0 hover:before:w-full">
