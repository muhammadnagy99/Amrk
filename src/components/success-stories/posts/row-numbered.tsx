...
export default function RowNumbered({ content }: ArticleComponentProps) {
  return (
    <div className="flex flex-col md:flex-row w-full border-b pt-6 pb-6 md:p-8 gap-4">
      ...
      <ul className="customList list-decimal list-inside w-full md:w-1/2 text-primText">
        {content.quoteBefore && (
        ...
        {content.content.map((part, index) => (
          <li key={index} className="mb-2 text-base font-light">
