...
export const contentData: ServicesContentType[] = [
    ...
    },
    {
        ...
        props: {
            ...
            listItems: [
              "نسبة الطلبات التي يتم تسليمها في الوقت المحدد داخل منطقة التوصيل الجغرافية المحددة.",
              "تقليل تكاليف التوصيل من خلال تحسين مسارات التوصيل.",
              "تحسين دقة تتبع الطلبات بفضل التحديد الجغرافي المسبق لتوصيل الطلبات.",
              "زيادة في درجات رضا العملاء المتعلقة بسرعة التوصيل."
            ]
        }
    }
];
