...
export const contentData: ServicesContentType[] = [
    ...
    },
    {
        ...
        props: {
            ...
            listItems: [
                "نمو في الأعمال المتكررة من المشاركين في برنامج الولاء.",
                "زيادة في معدلات استرداد مكافآت الولاء.",
                "تحسين معدلات الاحتفاظ بالعملاء من خلال عروض الولاء.",
                "ارتفاع متوسط إنفاق العميل بفضل دمج مكافآت الولاء."
            ]
        }
    }
];
