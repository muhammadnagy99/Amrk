    ...
    },
    {
        ...
        props: {
            ...
            listItems: [
               ...
               "رفع نسبة الطلبات المستلمة في الوقت المحدد مقابل الطلبات المتأخرة أو الفائتة.",
               "زيادة العملاء المتكررين لخدمة الاستلام لملاءمتها احتياجاتهم للسرعة وعدم الانتظار.",
               "فعالية الإشعارات الفورية لتقليل استفسارات العملاء."
            ]
        }
    }
];
