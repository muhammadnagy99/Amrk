...
export const contentData: ServicesContentType[] = [
    ...
    },
    {
        ...
        props: {
            ...
            listItems: [
              "تقليل متوسط وقت أخذ الطلبات باستخدام QR على الطاولة مقارنة بالطرق التقليدية.",
              "زيادة قيمة الفاتورة بفضل الترويج الرقمي للعروض الخاصة.",
              "تسريع دفع الفواتير وتقسيمها مباشرة من جوالات العملاء.",
              "تقليل الأخطاء الناتجة عن إدخال الطلبات يدويًا وتحسين جمع بيانات العملاء."
            ]
        }
    }
];
