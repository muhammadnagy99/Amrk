...
export const contentData: ServicesContentType[] = [
    ...
    },
    {
        ...
        props: {
            ...
            listItems: [
                "زيادة حجم الطلبات الناتجة عن منصات التواصل الاجتماعي.",
                "معدل تحويل المتابعين على وسائل التواصل الاجتماعي إلى عملاء.",
                "تحسين تفاعل العملاء من خلال حملاتك التسويقية على وسائل التواصل.",
                "توفير الوقت من خلال معالجة الطلبات مباشرةً عبر منصات التواصل الاجتماعي."
            ]
        }
    }
];
