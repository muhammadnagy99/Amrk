...
export const contentData: ServicesContentType[] = [
    ...
    },
    {
        ...
        props: {
            ...
            listItems: [
                "تقليل نسبة الحجوزات الفائتة عبر التأكيدات الآلية.",
                "زيادة سعة الحجوزات خلال ساعات الذروة.",
                "تحسين إدارة الحجوزات لزيادة معدل دوران الطاولات.",
                "زيادة رضا العملاء من خلال السهولة والمرونة في الحجز."
            ]
        }
    }
];
