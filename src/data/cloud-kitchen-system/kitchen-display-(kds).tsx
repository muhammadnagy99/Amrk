...
export const contentData: ServicesContentType[] = [
    ...
    },
    {
        ...
        props: {
            ...
            listItems: [
                "ضمان إتمام الطلبات بدقة وفي الوقت المحدد.",
                "تحسين عرض الطلبات بين العلامات التجارية المختلفة على شاشة موحدة.",
                "زيادة سرعة تحضير الطلبات في عمليات تشغيل العلامات التجارية المتعددة.",
                "تقليل الارتباك في المطبخ وتأخير الطلبات من خلال تتبع مركزي."
            ]
        }
    }
];
