...
export const contentData: ServicesContentType[] = [
    ...
    },
    {
        ...
        props: {
            ...
            listItems: [
               "تقليل نسبة نفاد المخزون بفضل إعادة الطلب الآلي.",
               "تقليل هدر الطعام بفضل التتبع الدقيق للمكونات عبر العلامات التجارية المتعددة.",
               "تحسين دقة مستويات المخزون في المطابخ السحابية.",
               "تسريع تنفيذ طلبات الشراء بفضل البيانات الحظية للمخزون في المطبخ السحابي."
            ]
        }
    }
];
