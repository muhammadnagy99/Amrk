...
export const contentData: ServicesContentType[] = [
    ...
    },
    {
        ...
        props: {
            ...
            listItems: [
                "تقليل الوقت المستغرق في تحديث القوائم وزيادة دقة الطلبات بالتحديثات اللحظية.",
                "تسريع تنفيذ الطلبات من خلال تحسين التواصل بين العلامات التجارية والمطبخ.",
                "سرعة تعديل قوائم الطعام بناءً على العروض الترويجية والموسمية.",
                "تحسين رضا العملاء بفضل القوائم المحدثة في تطبيقات التوصيل والأونلاين."
            ]
        }
    }
];
