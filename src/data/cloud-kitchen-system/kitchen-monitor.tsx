...
export const contentData: ServicesContentType[] = [
    ...
    },
    {
        ...
        props: {
            ...
            listItems: [
                "تتبع مؤشرات الأداء الأساسية في الوقت الفعلي.",
                "تحسين الأداء في المطبخ بفضل البيانات المستمرة.",
                "تحديد سريع للاختناقات في تحضير الوجبات.",
                "تقليل الهدر بفضل متابعة فعالة للموارد."
            ]
        }
    }
];
