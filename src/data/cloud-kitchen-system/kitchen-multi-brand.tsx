...
export const contentData: ServicesContentType[] = [
    ...
    },
    {
        ...
        props: {
            ...
            listItems: [
                "زيادة في كفاءة المطبخ السحابي بفضل إدارة العلامات التجارية المتعددة.",
                "تقليل الأخطاء في الطلبات المتعلقة بعلامة تجارية معينة بفضل إدارة المنيو المبسطة.",
                "رفع دقة حصر المخزون في المطبخ السحابي، عبر حساب الاستهلاك لعلامات التجارية المتعددة.",
                "تحسين التقارير المركزية لاتخاذ قرارات مستنيرة."
            ]
        }
    }
];
