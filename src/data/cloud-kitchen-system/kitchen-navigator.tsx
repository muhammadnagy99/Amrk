...
export const contentData: ServicesContentType[] = [
    ...
    },
    {
        ...
        props: {
            ...
            listItems: [
                "تقليل وقت الطهي بفضل الخطوات إرشادات لتحضير للوجبات.",
                "تقليل الأخطاء في الطهي من خلال إرشادات واضحة للطهاة.",
                "تحسين تناسق إعداد الوجبات عبر العلامات التجارية المتعددة.",
                "زيادة إنتاجية المطبخ خلال فترات الذروة بفضل إرشادات محددة لأماكن تواجد المكونات."
            ]
        }
    }
];
