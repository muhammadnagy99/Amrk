...
export const contentData: ServicesContentType[] = [
    ...
    },
    {
        ...
        props: {
            ...
            listItems: [
                "زيادة سرعة معالجة الطلبات للمطابخ السحابية متعددة العلامات التجارية.",
                "تحسين دقة ادخال الطلبات لعلامات تجارية متعددة من شاشة نقاط بيع واحد.",
                "تقليل وقت معالجته الطلبات عبر نظام موحد.",
                "تقليل الأخطاء الناتجة عن الإدخال اليدوي بفضل تكامل نقاط البيع."
            ]
        }
    }
];
