...
export const megaMenuData_en = {
  ...
  sections: [
    ...
    },
    {
      ...
      icon: <Icon4 />,
      links: [
        { text: "Kitchen Multi-Brand", url: "/multiple-kitchen-brands" },
        { text: "Kitchen Display (KDS)", url: "/single-kitchen-screen" },
        { text: "Kitchen Inventory", url: "/kitchen-inventory" },
        { text: "Kitchen Menu", url: "/kitchen-menus" },
        { text: "Kitchen POS", url: "/kitchen-pos-system" },
        { text: "Kitchen Navigator", url: "/kitchen-guide" },
        { text: "Kitchen Monitor", url: "/kitchen-monitoring" },
        {
