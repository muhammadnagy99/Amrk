...
export const contentData: ServicesContentType[] = [
    ...
    },
    {
        ...
        props: {
            ...
            listItems: [
                "التخلص من عمليات الشراء غير المصرح بها عبر تحسين السيطرة على الموافقات.",
                "تسريع أوقات الموافقات بفضل الأذونات المؤتمتة.",
                "زيادة الشفافية في تتبع المشتريات عبر التقارير الدقيقة.",
                "تقليل الفائض في الإنفاق من خلال متابعة عمليات الشراء."
            ]
        }
    }
];
