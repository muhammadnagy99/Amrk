...
export const contentData: ServicesContentType[] = [
    ...
    },
    {
        ...
        props: {
            ...
            listItems: [
                "رفع ربحية المنتجات من خلال تتبع لحظي لتكاليف المكونات.",
                "تحسين هوامش الربح بفضل التعديلات الآلية على الوصفات.",
                "تتبع لحظي للأسعار المكونات وتأثيرها على الهوامش.",
                "تقليل هدر الطعام بفضل التتبع الدقيق للحصص والوصفات."
            ]
        }
    }
];
