...
export const contentData: ServicesContentType[] = [
    ...
    },
    {
        ...
        props: {
            ...
            listItems: [
                "تقليل هدر المخزون من خلال التحديثات اللحظية.",
                "تقليل حالات نفاذ المخزون خلال أوقات الذروة.",
                "تسريع عملية مطابقة المخزون بين الفروع.",
                "تحسين تتبع استخدام المكونات لتقليل الفروقات."
            ]
        }
    }
];
