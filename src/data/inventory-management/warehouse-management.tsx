...
export const contentData: ServicesContentType[] = [
    ...
    },
    {
        ...
        props: {
            ...
            listItems: [
               "تقليل أوقات نقل المخزون بين مواقعك المختلفة.",
               "تقليل فقدان المخزون بفضل إدارة مركزية للمخزون.",
               "تحسين كفاءة سلسلة التوريد بفضل التتبع اللحظي لتوريداتك.",
               "توزيع مخزون مثالي بناءً على تحليلات التوقعات الطلبات المستقبلية."
            ]
        }
    }
];
