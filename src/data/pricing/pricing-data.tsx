...
export const heading = {
  ...
  description:
    "ابدأ مجاناً مع إمكانية إضافة الأدوات حسب الحاجة، أو اختر من خططنا الشاملة لتلبية جميع احتياجات مطبخك من البداية.",
  show: {
    more: "عرض المزيد",
    less: "عرض أقل",
  },
...
export const accordionData: AccordionData[] = [
  ...
  },
  {
    ...
    rows: [
      {
        rowTitle: "منيو للعلامات التجارية المتعددة",
  ...
  },
  {
    ...
    rows: [
      ...
      {
        rowTitle: "QR لتقسم الفاتورة على الطاولة",
        iconStates: [false, false, false, true, true],
      },
      {
      ...
      {
        rowTitle: "تحليلات إشغال الطاولات",
        iconStates: [false, false, false, true, true],
      },
    ],
  },
  {
    ...
    rows: [
      ...
      {
        rowTitle: "صلاحيات الموافقات الإلكترونية",
        iconStates: [false, false, false, true, true],
      },
    ],
  },
  {
    ...
    rows: [
      {
        rowTitle: "العروض التسويقية",
        iconStates: [true, true, true, true, true],
      },
      {
        rowTitle: "بطاقات الهدايا",
        iconStates: [true, true, true, true, true],
      },
      {
        rowTitle: "جهاز دفع مدمج Payment Terminal",
        iconStates: [false, true, true, true, true],
      },
      {
        rowTitle: "شاشة المطبخ",
        iconStates: [false, true, true, true, true],
      },
      {
        rowTitle: "شاشة الخدمة",
        iconStates: [false, false, true, true, true],
      },
      {
        rowTitle: "صفحات ويب لنقاط البيع, شاشة المطبخ, شاشة الخدمة",
        iconStates: [false, true, true, true, true],
      },
      {
        rowTitle: "ورديات الموظفين",
        iconStates: [false, true, true, true, true],
      },
      {
        rowTitle: "ووكي توكي مدمج",
        iconStates: [false, true, true, true, true],
      },
      {
        rowTitle: "وضع عدم الإتصال",
        iconStates: [false, true, true, true, true],
      },
      {
        rowTitle: "فواتير متوافقة مع ZATCA",
        iconStates: [true, true, true, true, true],
      },
    ],
  },
...
export const heading_en = {
  ...
  description:
    "Start free with add-on tools as needed, or choose from our comprehensive plans to meet all your kitchen's needs from the start.",
  show: {
    more: "Show More",
    less: "Show Less",
  },
...
export const packagesData_en: Package[] = [
  {
    title: "Online Store",
    description:
      "Convenient for expanding your online presence, offering online sales, orders management, online payments, and delivery.",
    buttonText: "Free",
    buttonVariant: "primary",
    highlight: false,
  },
  {
    ...
    description:
      "Convenient for mobile businesses like food trucks, pop-ups, or home-based ventures, offering mobile order and payment solutions.",
  ...
  },
  {
    title: "Quick Service",
    description:
      "Perfect for busy coffee shops, bakeries, and quick-service restaurants, enhancing speed and efficiency in customer service, order customization, and tracking.",
    buttonText: "Contact Sales",
    buttonVariant: "outline",
    highlight: false,
  },
  {
    ...
    description:
      "Ideal for full-service restaurants, providing advanced solutions to streamline operations, simplify order processing, and enhance the dining experience.",
    buttonText: "Contact Sales",
    buttonVariant: "outline",
    highlight: false,
  },
  {
    ...
    description:
      "Convenient for Cloud or Central Kitchens, managing multiple brands from one location, optimizing online orders, kitchen workflows, and delivery.",
    buttonText: "Contact Sales",
    buttonVariant: "outline",
    highlight: true,
...
export const accordionData_en: AccordionData[] = [
  ...
  },
  {
    ...
    rows: [
      ...
      {
        rowTitle: "Warehouse, Central Kitchen, and Virtual Brands",
        iconStates: [false, false, false, true, true],
      },
      {
  ...
  },
  {
    ...
    rows: [
      ...
      {
        rowTitle: "Payment Terminal",
        iconStates: [true, true, true, true, true],
      },
      {
        rowTitle: "Kitchen Display Screen (KDS)",
        iconStates: [true, true, true, true, true],
      },
      {
        rowTitle: "Serving Station Screen (SSS)",
        iconStates: [true, true, true, true, true],
      },
      {
        rowTitle: "Web Cashier, Kitchen Display, & SSS",
        iconStates: [true, true, true, true, true],
      },
      {
        rowTitle: "Employees Timecard (Shifts)",
        iconStates: [true, true, true, true, true],
      },
      {
        rowTitle: "Walkie-Talkie",
        iconStates: [true, true, true, true, true],
      },
      {
        rowTitle: "Offline Mode",
        iconStates: [true, true, true, true, true],
      },
      {
        rowTitle: "ZATCA Compliant Receipts",
        iconStates: [true, true, true, true, true],
      },
    ],
  },
  ...
  {
    type: "accordion",
    title: "Virtual Brands Operations System",
    rows: [
      {
